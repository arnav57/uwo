function [Vg,Vm,t] = biphasic_exp_fixed_tilt(tau_m,Cg,del_E,R_meas,tilt1,tilt2,show)
% Specify tau_m in ms, Cg in microfarads.

tau_m = tau_m/1000;    % Convert to seconds
Cg = Cg/1e6;            % Convert to farads
...
dur1 = -1*tau_g*log(1 - tilt1);
dur2 = -1*tau_g*log(1 - tilt2);
...
target_strength2 = (1 - tilt1)*target_strength;
